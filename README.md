...
统一运行时产品化阶段的最高层开发基线见 [《懒人装甲：统一运行时产品化总规划 v1.0》](./docs/runtime-productization-plan-v1.0.md)。

> **懒人装甲采用“19 个稳定生活领域 + 96 个标准业务场景 + 8 种通用计划策略 + 15 步统一执行闭环”的产品与执行模型。**
>
> **领域和场景定义“管什么”，策略定义“怎么管”，15 步闭环定义“系统怎么安全、可靠地把事情办完”。**
