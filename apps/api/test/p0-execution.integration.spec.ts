...
class RuntimeTestConnector implements Connector {
  ...
  metadata = () => ({ key: this.key, name: 'P0-5 Test Connector', description: 'Only registered inside integration tests', version: '1.0.0-test' });
  capabilities = () => [{ key: 'TEST_EXECUTE', name: 'Test execute', riskLevel: 'R1' as const, operation: 'execute' as const }];
