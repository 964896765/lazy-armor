...
class SafetyTestConnector implements Connector {
  ...
  capabilities = () => [
    ...
    { key: 'TEST_R4_EXTERNAL', name: 'Financial account simulation', operation: 'execute' as const, riskLevel: 'R4' as const, requiredPermission: 'TEST_R4_EXTERNAL' },
  ];
