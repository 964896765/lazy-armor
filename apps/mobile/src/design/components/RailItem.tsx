...
const styles = StyleSheet.create({
  ...
  selectionMark: { position: 'absolute', left: -5, width: 3, height: 24, borderRadius: 3, backgroundColor: colors.primary },
  icon: { width: 34, height: 34, borderRadius: 11, backgroundColor: '#F1F3F6', alignItems: 'center', justifyContent: 'center', position: 'relative', overflow: 'visible' },
  image: { width: 34, height: 34, borderRadius: 11 },
  defaultIcon: { backgroundColor: '#F1F3F6' },
  brandIcon: { backgroundColor: colors.primary },
  commerceIcon: { backgroundColor: colors.primary },
  actionIcon: { backgroundColor: colors.accentSoft, borderWidth: 1, borderColor: '#FFDFBE' },
  ...
  healthy: { backgroundColor: colors.success },
