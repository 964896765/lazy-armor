...
export const CANONICAL_DOMAIN_CATALOG: readonly CanonicalDomainDefinition[] = Object.freeze([
  ...
  { key: 'life', label: '日常事务', group: 'life' },
  ...
  { key: 'entertainment', label: '休闲娱乐', group: 'life' },
  { key: 'work', label: '工作', group: 'work' },
  { key: 'operations', label: '运营', group: 'work' },
  { key: 'content', label: '内容创作', group: 'work' },
  { key: 'study', label: '学习', group: 'work' },
  { key: 'identity_docs', label: '证件', group: 'work' },
  { key: 'government', label: '政务', group: 'work' },
  { key: 'legal_contract', label: '合同与法律事务', group: 'work' },
